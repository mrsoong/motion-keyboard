...
### Feb.27.2017 - 8pm-9pm
	...
	- What is your github workflow?
	- How does the specific github process suit the team's needs?
	- Master branch was working product, with extra branches for each feature and 1 for development
	- How to develop keyboard - give roles to everyone
	     
### Mar.6.2017 - 8pm-9pm     
	- Communication issues - always say if you are busy on slack 
	- Frederik situation – talk to him like a coworker
	- Go over the merging strategy – come up with a workable plan about who merges whose commits
	- Assign new roles next week with regard to who does what activity from the backlog
	- Plan a time when the video production team will shoot the footage
	- Upload meeting notes from previous iterations
